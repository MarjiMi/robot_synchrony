...
instructions = """Pay attention carefully, because your decisions will affect how much money you will win. 
The robotic arm moved through several obstacle courses a few days ago.
...
For easy obstacle courses, the robotic arm moved around zero to one obstacle, for medium, 2 obstacles, and for hard, 3 obstacles. 
In this task, you will rate your level of trust that the robotic arm completed the course without mistake from 0% trust to 100% trust.
If you are correct, easy obstacles will win you up to $0.25, medium obstacles  up to $0.50, and hard obstacles $1.00.
...
Likewise, If you have low trust in the robotic arm and it fails, you will win more money.
However, if you have low trust in the robotic arm and it succeeds, you will win less money.
You will get feedback about whether the robotic arm succeeded for two random hard obstacles.
That will give you an idea of how the robot is doing."""
